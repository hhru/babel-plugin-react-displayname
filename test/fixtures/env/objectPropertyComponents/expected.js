...
function FunctionComponent() {
  ...
  return _react["default"].createElement(ObjectPropertyComponent.invariant, {
...
function (_React$Component) {
  ...
  function ClassComponent() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(ClassComponent)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _defineProperty(_assertThisInitialized(_this), "ObjectPropertyComponent2", {
      invariant: function invariant(content) {
        return _react["default"].createElement("div", null, content);
      }
    });
  ...
  _createClass(ClassComponent, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement(ObjectPropertyComponent2.invariant, {
        content: "text content"
      });
    }
  }]);
...
function (_React$Component2) {
  ...
  function ClassComponent1() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(ClassComponent1).apply(this, arguments));
  }

  _createClass(ClassComponent1, [{
    key: "render",
    value: function render() {
      return _react["default"].createElement(ClassComponent1.ObjectPropertyComponent1.invariant, {
        content: "text content"
      });
    }
  }]);
