...
FunctionComponentVariableDeclarationWithList.displayName = "withoutEnv/variableDeclarationInComponent/input/FunctionComponentVariableDeclarationWithList";

const FunctionComponentVariableDeclarationWithList1 = list => {
  const content = React.createElement("div", null, list.map(({
    url,
    id,
    text
  }) => React.createElement("div", {
...
class ClassComponent extends React.Component {
  render() {
    const content = React.createElement("div", null, this.props.list.map(({
      url,
      id,
      text
    }) => React.createElement("div", {
