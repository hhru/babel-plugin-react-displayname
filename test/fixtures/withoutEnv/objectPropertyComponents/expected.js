...
function FunctionComponent() {
    const ObjectPropertyComponent = {
        invariant: content => React.createElement(
            "div",
            null,
            content
        )
    ...
    return React.createElement(ObjectPropertyComponent.invariant, { content: "text content" });
}
...
class ClassComponent extends React.Component {
    constructor(...args) {
        ...
        return _temp = super(...args), this.ObjectPropertyComponent2 = {
            invariant: content => React.createElement(
                "div",
                null,
                content
    ...
    render() {
        ...
        return React.createElement(ObjectPropertyComponent2.invariant, { content: "text content" });
    }
}
...
class ClassComponent1 extends React.Component {
    ...
    render() {
        return React.createElement(ClassComponent1.ObjectPropertyComponent1.invariant, { content: "text content" });
    }
}
...
ClassComponent1.ObjectPropertyComponent1.invariant.displayName = "withoutEnv/objectPropertyComponents/input/ClassComponent1.ObjectPropertyComponent1.invariant";