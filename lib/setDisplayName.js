...
var displayNames = {};
var TRANSPILE_ANONYMOUS_FUNCTION_NAME_START_SUMBOL = '_';
module.exports = {
  ...
  setDisplayName: function setDisplayName(path, nameNodeId, types, name) {
    ...
    if (Array.isArray(nameNodeId)) {
      ...
      abortAppend = TRANSPILE_ANONYMOUS_FUNCTION_NAME_START_SUMBOL !== declarationName.charAt(0) && declarationName.charAt(0) === declarationName.charAt(0).toLocaleLowerCase();
    }
